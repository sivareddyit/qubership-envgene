...
| **bg_domain** | Mandatory | Contains [bg_domain](./envgene-objects.md#bg-domain) object | {} | [example](#version-20topology-context-bg_domain-example) |
...
```yaml
bg_domain:
# Real BGD template from your file
