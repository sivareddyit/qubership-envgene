...
| Shared Template Variable File | `/environments/<cluster-name>/<env-name>/shared_template_variables/<file-name>.yml` | `/environments/<cluster-name>/shared_template_variables/<file-name>.yml` | `/environments/shared_template_variables/<file-name>.yml` |
...
```yaml
# /environments/shared_template_variables/prod-template-variables.yml
...
```yaml
# /environments/<cluster-name>/shared_template_variables/sample-cloud-template-variables.yml
