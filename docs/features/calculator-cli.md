...
| `SSL_SECRET`                      | yes       | string  | TBD                                                                                                    | `defaultsslcertificate`                        | N/A                                                                                          |
| `CERTIFICATE_BUNDLE_MD5SUM`       | yes       | string  | TBD                                                                                                    | None                                           | N/A                                                                                          |
...
| `BG_CONTROLLER_URL`               | yes       | string  | URL from the [BG Domain](/docs/envgene-objects.md#bg-domain) credential.                                                                                               | None            | N/A                                                                                      |
| `BG_CONTROLLER_LOGIN`             | yes       | string  | Username from the [BG Domain](/docs/envgene-objects.md#bg-domain) credential.                                                                                          | None            | N/A                                                                                      |
| `BG_CONTROLLER_PASSWORD`          | yes       | string  | Password from the [BG Domain](/docs/envgene-objects.md#bg-domain) credential.                                                                                          | None            | N/A                                                                                      |
| `BASELINE_PROJ`                   | yes       | string  | **Deprecated**                                                                                                                                                         | TBD             | N/A                                                                                      |
...
| `SSL_SECRET_VALUE`                       | no        | string | SSL Certificate bundle              | None    | TBD                                                                                                                                                                                                                   |
