...
public class Binding extends HashMap<String, Parameter> implements Cloneable {
    ...
    private void processSet(String tenant, String setName, String application, EscapeMap parameterSet, EscapeMap applicationMap) {
        ...
        if (set != null) {
            parameterSet.putAll(set.getParameters(), String.format(ParametersConstants.PARAMETER_SET_ORIGIN, setName));
            ...
            if (parameterSetApplication != null) {
                applicationMap.putAll(parameterSetApplication.getParameters(), String.format(ParametersConstants.PARAMETER_SET_APP_ORIGIN, setName, application));
            }
        }
    }
