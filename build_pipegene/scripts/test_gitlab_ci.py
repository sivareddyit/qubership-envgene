...
build_pipeline_test_data = [
    (  # with all jobs
        ...
        ["trigger", "process_passport", "env_inventory_generation", "env_builder", "generate_effective_set",
         "git_commit", "cmdb_import", "envgene_log_level"]
    ),
    ...
    (  # with inventory generation and without env_build, passport discovery and effective set
        PipelineVars(get_passport="false", env_builder="false", generate_effective_set="false",
                     sd_data='{"params": "value"}'),
